...
val baseApplicationId = "com.nirvana.music"
val applicationIdOverride = System.getenv("NIRVANA_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("NIRVANA_APP_NAME")?.takeIf { it.isNotBlank() }
val debugKeystorePathOverride = System.getenv("NIRVANA_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("NIRVANA_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("NIRVANA_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("NIRVANA_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
...
android {
    ...
    defaultConfig {
        ...
        versionCode = 150
        versionName = "13.6.1"
        resValue("string", "app_name", appNameOverride ?: "Nirvana")
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "Nirvana Debug")
            }
            signingConfig =
