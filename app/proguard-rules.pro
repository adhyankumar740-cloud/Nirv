...
# Since Nirvana is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.nirvana.music.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.nirvana.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class com.nirvana.music.utils.cipher.** { *; }
-keep class com.nirvana.music.utils.potoken.** { *; }
...
-keep class com.nirvana.music.models.PersistQueue { *; }
-keep class com.nirvana.music.models.PersistPlayerState { *; }
-keep class com.nirvana.music.models.QueueData { *; }
-keep class com.nirvana.music.models.QueueType { *; }
-keep class com.nirvana.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.nirvana.music.cast.** { *; }
...
-keep class com.nirvana.music.recognition.VibraSignature { *; }
-keepclassmembers class com.nirvana.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.nirvana.music.listentogether.proto.** { *; }
-keepclassmembers class com.nirvana.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.nirvana.shazamkit.models.** { *; }
-keepclassmembers class com.nirvana.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.nirvana.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.nirvana.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.nirvana.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}
