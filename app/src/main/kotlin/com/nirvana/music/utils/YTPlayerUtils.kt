...
package com.nirvana.music.utils

import android.net.ConnectivityManager
import android.net.Uri
import androidx.media3.common.PlaybackException
import com.nirvana.innertube.NewPipeExtractor
...
import com.nirvana.innertube.strategy.ContentAwareFallbackStrategy
import com.nirvana.innertube.strategy.ContentHints
import com.nirvana.music.constants.AudioQuality
import com.nirvana.music.utils.YTPlayerUtils.MAIN_CLIENT
import com.nirvana.music.utils.YTPlayerUtils.validateStatus
import com.nirvana.music.utils.cipher.CipherDeobfuscator
import com.nirvana.music.utils.cipher.FunctionNameExtractor
import com.nirvana.music.utils.cipher.PlayerJsFetcher
import com.nirvana.music.utils.potoken.PoTokenGenerator
import com.nirvana.music.utils.potoken.PoTokenResult
...
object YTPlayerUtils {
    ...
    suspend fun playerResponseForPlayback(
        ...
        if (streamPlayerResponse.playabilityStatus.status != "OK") {
            ...
            // unavailable streams; Nirvana cannot recover those without official playback.
