...
import com.nirvana.music.constants.ContentCountryKey
import com.nirvana.music.constants.ContentLanguageKey
import com.nirvana.music.constants.CountryCodeToName
import com.nirvana.music.constants.EnableBetterLyricsKey
import com.nirvana.music.constants.EnableKugouKey
import com.nirvana.music.constants.EnableLrcLibKey
import com.nirvana.music.constants.EnablePaxsenixKey
import com.nirvana.music.constants.EnableLyricsPlus
...
import com.nirvana.music.constants.LanguageCodeToName
import com.nirvana.music.constants.LyricsProviderOrderKey
import com.nirvana.music.constants.ProxyEnabledKey
import com.nirvana.music.constants.ProxyPasswordKey
import com.nirvana.music.constants.ProxyTypeKey
import com.nirvana.music.constants.ProxyUrlKey
import com.nirvana.music.constants.ProxyUsernameKey
import com.nirvana.music.constants.QuickPicks
import com.nirvana.music.constants.QuickPicksKey
import com.nirvana.music.constants.RandomizeHomeOrderKey
import com.nirvana.music.constants.SYSTEM_DEFAULT
import com.nirvana.music.constants.ShowArtistDescriptionKey
import com.nirvana.music.constants.ShowMostStatsPlaylistsKey
import com.nirvana.music.constants.ShowArtistSubscriberCountKey
import com.nirvana.music.constants.ShowMonthlyListenersKey
import com.nirvana.music.constants.ShowWrappedCardKey
import com.nirvana.music.constants.TopSize
...
import com.nirvana.music.ui.component.DraggableLyricsProviderItem
import com.nirvana.music.ui.component.DraggableLyricsProviderList
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.nirvana.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.nirvana.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.nirvana.music.db.entities.PlaylistEntity(
                        id = com.nirvana.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.nirvana.music.db.entities.PlaylistEntity(
                        id = com.nirvana.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
