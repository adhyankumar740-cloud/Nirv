...
import com.nirvana.music.constants.AndroidAutoSectionsOrderKey
import com.nirvana.music.constants.AndroidAutoYouTubePlaylistsKey
import com.nirvana.music.ui.screens.settings.AndroidAutoSection
import com.nirvana.music.ui.screens.settings.deserializeSections
import com.nirvana.music.ui.screens.settings.serializeSections
                ...
                when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.nirvana.innertube.pages.HomePage.Section>()
