package com.nirvana.music.discord
...
import com.nirvana.music.discord.DiscordDefaults.DISCORD_OAUTH_AUTHORIZE
import com.nirvana.music.discord.DiscordDefaults.DISCORD_OAUTH_TOKEN
import com.nirvana.music.discord.DiscordDefaults.DISCORD_SCOPES
...
class DiscordAuth(
    ...
    companion object {
        ...
        const val REDIRECT_URI = "nirvanadiscord://oauth2/callback"
