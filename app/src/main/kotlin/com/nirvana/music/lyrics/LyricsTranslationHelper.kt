...
import com.nirvana.music.api.DeepLService
import com.nirvana.music.api.MistralService
import com.nirvana.music.api.OpenRouterService
import com.nirvana.music.api.OpenRouterStreamingService
            ...
            scope.launch(Dispatchers.IO) {
                try {
                    ...
                    if (effectiveApiKey.isBlank()) {
                        _status.value = TranslationStatus.Error(context.getString(com.nirvana.music.R.string.ai_error_api_key_required))
                        return@launch
                    }

                    if (lyrics.isEmpty()) {
                        _status.value = TranslationStatus.Error(context.getString(com.nirvana.music.R.string.ai_error_no_lyrics))
                        return@launch
                    }
                    ...
                    if (nonEmptyEntries.isEmpty()) {
                        _status.value = TranslationStatus.Error(context.getString(com.nirvana.music.R.string.ai_error_lyrics_empty))
                        return@launch
                    }
                    ...
                    if (targetLanguage.isBlank()) {
                        _status.value = TranslationStatus.Error(context.getString(com.nirvana.music.R.string.ai_error_language_required))
                        return@launch
                    }
                    ...
                    result
                        ...
                        .onFailure { error ->
                            ...
                            val errorMessage = error.message ?: context.getString(com.nirvana.music.R.string.ai_error_unknown)
                    ...
                    if (e !is kotlinx.coroutines.CancellationException && isCompositionActive) {
                        val errorMessage = e.message ?: context.getString(com.nirvana.music.R.string.ai_error_translation_failed)
                        _status.value = TranslationStatus.Error(errorMessage)
                    }
                }
            }
