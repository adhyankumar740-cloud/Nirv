...
package com.nirvana.music.widget
...
import com.nirvana.music.recognition.MusicRecognitionService
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import com.nirvana.music.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.nirvana.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.nirvana.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.nirvana.music.widget.recognizer.RESET"
    }
}
