...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.nirvana.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.nirvana.music.widget.LIKE"
        const val ACTION_NEXT = "com.nirvana.music.widget.NEXT"
        const val ACTION_PREVIOUS = "com.nirvana.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.nirvana.music.widget.UPDATE_WIDGET"
    }
}
