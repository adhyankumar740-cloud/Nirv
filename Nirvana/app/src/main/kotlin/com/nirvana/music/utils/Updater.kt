...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/NirvanaGroup/Nirvana"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Nirvana.apk" -> "universal" to "foss"
                name == "Nirvana-with-Google-Cast.apk" -> "universal" to "gms"
