package com.nirvana.paxsenix

import android.content.Context
import com.nirvana.music.betterlyrics.TTMLParser
import com.nirvana.paxsenix.models.AppleMusicSearchResponse
import com.nirvana.paxsenix.models.LyricsResponse

import com.nirvana.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "Nirvana/$appVersion")
                }
