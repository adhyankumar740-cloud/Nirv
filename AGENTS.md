# Working with Nirvana as an AI agent

Nirvana is a 3rd party YouTube Music client written in Kotlin. It follows material 3 design guidelines closely.
...
3. All string edits should be made to the `Nirvana/app/src/main/res/values/nirvana_strings.xml` file, NOT `Nirvana/app/src/main/res/values/strings.xml`. Do not touch other `strings.xml` or `nirvana_strings.xml` files in the project. ONLY edit the default (English) `nirvana_strings.xml` file, DO NOT EDIT OTHER LANGUAGES.
